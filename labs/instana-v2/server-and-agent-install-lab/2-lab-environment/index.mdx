...
- Instana License
  - Download Key - The key can be found in the /media/readme.txt file on both the student and instana VMs.
  - Sales Key - The key can be found in the /media/readme.txt file on both the student and instana VMs.
