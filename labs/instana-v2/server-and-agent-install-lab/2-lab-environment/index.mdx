...
- Option 1: Open the lab guid within the **student** VM.  Then, you can copy/paste directly within the VM by highlighting text, doing a right click and selecting **Copy**
