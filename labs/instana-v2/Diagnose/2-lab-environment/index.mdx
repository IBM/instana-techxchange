...
2. **Instana** - An RHEL VM with an instance of Instana Server and Instana
   Agent running running in Docker.
3. **MQACE** - An RHEL VM that contains the pre-installed IBM ACE and MQ
   middleware.
...
You can follow
[these instructions](/instana-techxchange/labs/jam-in-a-box/#requesting-a-lab-environment)
