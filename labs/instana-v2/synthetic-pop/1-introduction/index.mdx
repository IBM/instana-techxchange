...
This lab focuses on two Instana features.  The first is Synthetic Monitoring.  The second is the Action Catalog where you can create and execute automated corrective actions.
