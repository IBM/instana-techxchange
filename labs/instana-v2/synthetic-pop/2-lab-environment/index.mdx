...
1. **Kubernetes cluster** - Kubernetes VM - An instance of Kubernetes cluster where you will install Instana Synthetics Point of Presence and Instana Action Catalog.
2. **K3s cluster** - RH8 VM - An instance of K3s cluster with pre-installed Instana backend.
...
2. **Infra NFS** - A RHEL VM that contains the pre-installed NFS storage, IBM ACE and MQ middleware.
