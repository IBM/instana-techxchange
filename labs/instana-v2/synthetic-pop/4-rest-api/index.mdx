...
The API Token is now in your clipboard, but it probably makes sense to save it to a file so that you can access it later. For example, in the folder /user/ibmuser/Documents, you can create a new file (you can give any name for your ew file) and paste the token information in that file.
