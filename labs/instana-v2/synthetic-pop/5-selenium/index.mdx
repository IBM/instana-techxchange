...
Back at the **Step 2: Request details**, select the Point of Presence that you had just created previously in Lab3. (The PoP listed in the UI may not be the same name as of the PoP you had created previously). Then click on **Next** button.
...
Next, on the **Results** tab, and you can click on anyone of the test results in the list to see the detailed result of the synthetic test.
