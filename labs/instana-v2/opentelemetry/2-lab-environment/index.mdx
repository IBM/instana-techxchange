...
1. **kmaster** - Kubernetes VM - An instance of Kubernetes cluster with pre-installed OpenTelemetry Collector and Instana Agent
2. **kworker** - compute node, part of a Kubernetes cluster. Not used in ths lab
3. **Instana** - RH8 VM - An instance of pre-installed Instana Standard backend
