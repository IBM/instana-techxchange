...
In this section you will focus on exploring Instana's native tracing capabilities. Within the Instana UI, select Analytics (1).  Then, add two Filter criteria as shown below.

- Application name: your application name (2)
- Service name: frontendproxy (3)
...
Notice taht the trace context is quite different from the formatting when looking at a native Instana trace.
