...
Next, edit the configmap by typing the command shown below.   Do NOT copy/paste this command or you will lose the configmap content from your buffer.
...
* Finally, click the "Create" button to create the application perspective as seen below.
...
Now that the "Application Perspective" has been defined and the demo application is back up and running, let's generate some traffic. 
